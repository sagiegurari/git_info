...
[![crates.io](https://img.shields.io/crates/v/git_info.svg)](https://crates.io/crates/git_info) [![Build Status](https://travis-ci.org/sagiegurari/git_info?branch=master&svg=true)](http://travis-ci.org/sagiegurari/git_info) [![Build status](https://codecov.io/gh/sagiegurari/git-info/branch/master/graph/badge.svg)](https://ci.appveyor.com/project/sagiegurari/git-info) [![codecov](https://codecov.io/gh/sagiegurari/git_info/branch/master/graph/badge.svg)](https://codecov.io/gh/sagiegurari/git_info)<br>
